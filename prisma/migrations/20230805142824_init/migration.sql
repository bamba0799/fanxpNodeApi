...
CREATE TABLE `MatchTicketUser` (
    ...
    UNIQUE INDEX `MatchTicketUser_matchId_ticketId_userId_key`(`matchId`, `ticketId`, `userId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `MatchStageTeam` (
    ...
    UNIQUE INDEX `MatchStageTeam_matchId_stageId_teamId_key`(`matchId`, `stageId`, `teamId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `OTP` ADD CONSTRAINT `OTP_userContact_fkey` FOREIGN KEY (`userContact`) REFERENCES `User`(`contact`) ON DELETE RESTRICT ON UPDATE CASCADE;
